...
#tlogin:focus {
	...
	<body>
		...
		<div id="middle">
			<form action="admin/login" method="post">
				<ul style="text-align: center;">
					...
					<li>
						<input class="name" name="name" placeholder="请输入用户名" autocomplete="off">
					</li>
					<li>
						<input type="password" name="password" class="pwd" placeholder="请输入密码" autocomplete="off">
					</li>
					<li>
		...
		<div id="cloud"></div>
		<script src="/styles/bootstrap/js/jquery-1.10.2.js" type="text/javascript"
